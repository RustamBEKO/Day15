  ...
  return (
    <div className={styles.board}>
      ...
      <ul className="space-y-3">
        {boards.map((board) => (
          <li key={board.id} className="bg-white grid grid-cols-[0.15fr_1fr_3fr_0.5fr] gap-auto p-4 text-l  gap-2 justify-between border border-gray-300 border-r-8 border-l-8 hover:bg-gray-100 shadow-lg">
      ...
      <br />
      <button onClick={handleAddBoard} className="bg-amber-500 hover:bg-amber-400 text-white font-bold py-2 px-4 border-b-4 border-amber-700 hover:border-amber-500 rounded transition-colors duration-300">Добавить задачу</button>
